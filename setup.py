#!/usr/bin/env python
"""
Package metadata for course_summary.
"""
import os
import re
import sys
...
VERSION = get_version('course_summary', '__init__.py')
...
setup(
    name='course_summary',
    version=VERSION,
    description="""View course structure in document""",
    long_description=README + '\n\n' + CHANGELOG,
    author='MasterGowen',
    author_email='mastergowen@gmail.com',
    url='https://github.com/urfu-online/course_summary',
    packages=find_packages(
        include=['course_summary', 'course_summary.*'],
        exclude=["*tests"],
    ),
