...
"""
course_summary documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'course_summary',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/urfu-online/course_summary",
...
#
# html_title = 'course_summary v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'View course structure in document',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'course_summary'),
                os.path.join(root_path, 'course_summary/migrations')])
